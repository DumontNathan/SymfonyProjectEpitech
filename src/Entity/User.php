...
class User implements UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Favorite", mappedBy="user_id")
     */
    private $favorite_id;
    ...
    public function addFavoriteId(Favorite $favoriteId): self
    {
    ...
    public function removeFavoriteId(Favorite $favoriteId): self
    {
        if ($this->favorite_id->contains($favoriteId)) {
            $this->favorite_id->removeElement($favoriteId);
